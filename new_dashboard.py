...
def dashboard():
    ...
    avg_rr = sum([t.get('risk_reward_actual', 0) for t in trade_log]) / len(trade_log) if trade_log else 0
                ...
                <div class="performance-grid">
                    ...
                    <div>
                        ...
                        <div class="metric-row">
                            ...
                            <span class="metric-value">-{abs(min([t.get('pnl', 0) for t in trade_log])) if trade_log else 0:.2f}</span>
                        </div>
                        <div class="metric-row">
                            <span class="metric-label">Profit Factor:</span>
                            <span class="metric-value">{(sum([t.get('pnl', 0) for t in trade_log if t.get('pnl', 0) > 0]) / abs(sum([t.get('pnl', 0) for t in trade_log if t.get('pnl', 0) < 0]))):.2f if trade_log and any(t.get('pnl', 0) < 0 for t in trade_log) else 0}</span>
                        </div>
                    </div>
                </div>
            </div>
